...
(defun bup (note length &key (d (1- length)))
  (para
   ;;(note 1 length (et note) :d d :cfg '(:env nil :loop nil :duty 0 :vol 6))
   (note 0 length (* (et (+ note -1.6 ))) :d d :cfg '(:env nil :loop nil :duty 1 :vol 10))
...
(defpattern sax-234 (:accompany ((seq (bassline-2)
  ...
  (seq (bup 14 32)
       ...
       (note 0 24 (et 5))
       (bup 10 (+ 8 64))
       (note 0 32 (et 11) :d 30)
       (note 0 24 (et  9) :d 23)
       (bup 14 (+ 8 64))

       (bup 15 32)
       (note 0 24 (et 15) :d 20)
       (note 0 (+ 8 64) (et 18) :d 64)
       (bup 19 32)
       (note 0 24 (et 19) :d 20)
       (note 0 (+ 8 64) (et 22) :d 64)
