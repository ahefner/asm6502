...
(defpattern chords-7B (:accompany ((bassline-7B)))
  (rst 48)
  (rst 48)
  (chord (+ 12 4) 7 -0.2 t  6 3 -2 -13)
  (rst (+ -4 12 24))
  (rst 8)
  (chord (+ 8 4) 7 -0.2 t  7 3 0 -4)
  (rst (- 12 4))
  (chord 24 7 -0.2 t  7 2 -3 -14))

(defpattern chords-7C (:accompany ((bassline-7C)))
  (chord 12 7 -0.2 t  5 2 -2)
  (rst 36)
  (rst 6)
  (chord (+ 6 4) 7 -0.2 t  4 0 -5 -15)
  (rst (- 12 4))
  (chord 24 7 -0.2 nil  6 3 0 10)
  (chord (+ 12 4) 7 -0.2 t  9 6 2 -1 -5 -10)
  (rst (- 36 4))
  (chord 24 7 -0.2 nil  11 8 4 1 -1)
  (chord 24 7 -0.2 t    10 6 4 1 -2))
