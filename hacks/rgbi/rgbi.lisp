...
(let* ((*context* (make-instance 'basic-context :address #x8000))
  ...
  ;; Program different palette (DEBUG)
  (ppuaddr #x3F00)
  (dolist (color '(#xF #x07 #x17 #x27
                   #xF #x07 #x17 #x27
                   #xF #x07 #x17 #x27
                   #xF #x07 #x17 #x27))
      (poke color +vram-io+))
  ...
  (poke #b00001000 +ppu-cr2+)   ; BG visible, SPR off
  (jsr 'wait-vblank)
  (jsr 'wait-vblank)
  ...
  (procedure frame
    (ppuaddr #x2000)                    ; Reset PPU address after palette update
...
;    (emit-delay 50)
  ...
  (write-ines "/tmp/rgbi.nes"
              ...
              :chr (concatenate 'vector
                                (ichr:encode-gif "red.gif")
                                (ichr:encode-gif "green.gif")
                                (ichr:encode-gif "blue.gif")
                                (ichr:encode-gif "red.gif"))))
